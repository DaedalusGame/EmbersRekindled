...
public class TileEntityPulserRenderer extends TileEntitySpecialRenderer<TileEntityPulser> {
	...
	public TileEntityPulserRenderer(){
		super();
	}
	
	@Override
	public void render(TileEntityPulser tile, double x, double y, double z, float partialTicks, int destroyStage, float tileAlpha){
		if (tile != null){
            ...
            if (tile.south == TileEntityPulser.EnumConnection.LEVER){
