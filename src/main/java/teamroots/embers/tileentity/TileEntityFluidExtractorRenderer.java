...
public class TileEntityFluidExtractorRenderer extends TileEntitySpecialRenderer {
	...
	public TileEntityFluidExtractorRenderer(){
		super();
	}
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialTicks, int destroyStage){
		if (tile instanceof TileEntityFluidExtractor){
			TileEntityFluidExtractor pipe = (TileEntityFluidExtractor)tile;
            ...
            if (pipe.up == TileEntityFluidPipe.EnumPipeConnection.PIPE || pipe.up == TileEntityFluidPipe.EnumPipeConnection.BLOCK || pipe.up == TileEntityFluidPipe.EnumPipeConnection.LEVER){
            	RenderUtil.addBox(buffer, up.x1+x, up.y1+y, up.z1+z, up.x2+x, up.y2+y, up.z2+z, up.textures, new int[]{1,1,1,1,1,1});
            }
            if (pipe.down == TileEntityFluidPipe.EnumPipeConnection.PIPE || pipe.down == TileEntityFluidPipe.EnumPipeConnection.BLOCK || pipe.down == TileEntityFluidPipe.EnumPipeConnection.LEVER){
            	RenderUtil.addBox(buffer, down.x1+x, down.y1+y, down.z1+z, down.x2+x, down.y2+y, down.z2+z, down.textures, new int[]{-1,-1,1,1,1,1});
            }
            if (pipe.north == TileEntityFluidPipe.EnumPipeConnection.PIPE || pipe.north == TileEntityFluidPipe.EnumPipeConnection.BLOCK || pipe.north == TileEntityFluidPipe.EnumPipeConnection.LEVER){
            ...
            if (pipe.south == TileEntityFluidPipe.EnumPipeConnection.PIPE || pipe.south == TileEntityFluidPipe.EnumPipeConnection.BLOCK || pipe.south == TileEntityFluidPipe.EnumPipeConnection.LEVER){
            ...
            if (pipe.west == TileEntityFluidPipe.EnumPipeConnection.PIPE || pipe.west == TileEntityFluidPipe.EnumPipeConnection.BLOCK || pipe.west == TileEntityFluidPipe.EnumPipeConnection.LEVER){
            	RenderUtil.addBox(buffer, west.x1+x, west.y1+y, west.z1+z, west.x2+x, west.y2+y, west.z2+z, west.textures, new int[]{1,1,1,1,1,1});
            }
            if (pipe.east == TileEntityFluidPipe.EnumPipeConnection.PIPE || pipe.east == TileEntityFluidPipe.EnumPipeConnection.BLOCK || pipe.east == TileEntityFluidPipe.EnumPipeConnection.LEVER){
