...
public class TileEntityFluidExtractorRenderer extends TileEntitySpecialRenderer<TileEntityFluidExtractor> {
	...
	public void render(TileEntityFluidExtractor tile, double x, double y, double z, float partialTicks, int destroyStage, float tileAlpha){
		if (tile != null){
            ...
            if (tile.up == TileEntityFluidPipe.EnumPipeConnection.PIPE || tile.up == TileEntityFluidPipe.EnumPipeConnection.BLOCK || tile.up == TileEntityFluidPipe.EnumPipeConnection.LEVER){
            	RenderUtil.addBox(buffer, up.x1+x, up.y1+y, up.z1+z, up.x2+x, up.y2+y, up.z2+z, up.textures, new int[]{1,1,1,1,1,1});
            }
            if (tile.down == TileEntityFluidPipe.EnumPipeConnection.PIPE || tile.down == TileEntityFluidPipe.EnumPipeConnection.BLOCK || tile.down == TileEntityFluidPipe.EnumPipeConnection.LEVER){
            	RenderUtil.addBox(buffer, down.x1+x, down.y1+y, down.z1+z, down.x2+x, down.y2+y, down.z2+z, down.textures, new int[]{-1,-1,1,1,1,1});
            }
            if (tile.north == TileEntityFluidPipe.EnumPipeConnection.PIPE || tile.north == TileEntityFluidPipe.EnumPipeConnection.BLOCK || tile.north == TileEntityFluidPipe.EnumPipeConnection.LEVER){
            ...
            if (tile.south == TileEntityFluidPipe.EnumPipeConnection.PIPE || tile.south == TileEntityFluidPipe.EnumPipeConnection.BLOCK || tile.south == TileEntityFluidPipe.EnumPipeConnection.LEVER){
            ...
            if (tile.west == TileEntityFluidPipe.EnumPipeConnection.PIPE || tile.west == TileEntityFluidPipe.EnumPipeConnection.BLOCK || tile.west == TileEntityFluidPipe.EnumPipeConnection.LEVER){
            	RenderUtil.addBox(buffer, west.x1+x, west.y1+y, west.z1+z, west.x2+x, west.y2+y, west.z2+z, west.textures, new int[]{1,1,1,1,1,1});
            }
            if (tile.east == TileEntityFluidPipe.EnumPipeConnection.PIPE || tile.east == TileEntityFluidPipe.EnumPipeConnection.BLOCK || tile.east == TileEntityFluidPipe.EnumPipeConnection.LEVER){
