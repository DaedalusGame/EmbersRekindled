...
public class TileEntityPumpRenderer extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialTicks, int destroyStage){
		if (tile instanceof TileEntityPump){
			TileEntityPump pipe = (TileEntityPump)tile;
            ...
            if (pipe.up == TileEntityPipe.EnumPipeConnection.PIPE || pipe.up == TileEntityPipe.EnumPipeConnection.BLOCK || pipe.up == TileEntityPipe.EnumPipeConnection.LEVER){
            	RenderUtil.addBox(buffer, up.x1+x, up.y1+y, up.z1+z, up.x2+x, up.y2+y, up.z2+z, up.textures, new int[]{1,1,1,1,1,1});
            }
            if (pipe.down == TileEntityPipe.EnumPipeConnection.PIPE || pipe.down == TileEntityPipe.EnumPipeConnection.BLOCK || pipe.down == TileEntityPipe.EnumPipeConnection.LEVER){
            	RenderUtil.addBox(buffer, down.x1+x, down.y1+y, down.z1+z, down.x2+x, down.y2+y, down.z2+z, down.textures, new int[]{-1,-1,1,1,1,1});
            }
            if (pipe.north == TileEntityPipe.EnumPipeConnection.PIPE || pipe.north == TileEntityPipe.EnumPipeConnection.BLOCK || pipe.north == TileEntityPipe.EnumPipeConnection.LEVER){
            ...
            if (pipe.south == TileEntityPipe.EnumPipeConnection.PIPE || pipe.south == TileEntityPipe.EnumPipeConnection.BLOCK || pipe.south == TileEntityPipe.EnumPipeConnection.LEVER){
            ...
            if (pipe.west == TileEntityPipe.EnumPipeConnection.PIPE || pipe.west == TileEntityPipe.EnumPipeConnection.BLOCK || pipe.west == TileEntityPipe.EnumPipeConnection.LEVER){
            	RenderUtil.addBox(buffer, west.x1+x, west.y1+y, west.z1+z, west.x2+x, west.y2+y, west.z2+z, west.textures, new int[]{1,1,1,1,1,1});
            }
            if (pipe.east == TileEntityPipe.EnumPipeConnection.PIPE || pipe.east == TileEntityPipe.EnumPipeConnection.BLOCK || pipe.east == TileEntityPipe.EnumPipeConnection.LEVER){
            	RenderUtil.addBox(buffer, east.x1+x, east.y1+y, east.z1+z, east.x2+x, east.y2+y, east.z2+z, east.textures, new int[]{1,1,1,1,-1,-1});
            }
            if (pipe.up == TileEntityPipe.EnumPipeConnection.BLOCK || pipe.up == TileEntityPipe.EnumPipeConnection.LEVER){
            ...
            if (pipe.down == TileEntityPipe.EnumPipeConnection.BLOCK || pipe.down == TileEntityPipe.EnumPipeConnection.LEVER){
            ...
            if (pipe.north == TileEntityPipe.EnumPipeConnection.BLOCK || pipe.north == TileEntityPipe.EnumPipeConnection.LEVER){
            ...
            if (pipe.south == TileEntityPipe.EnumPipeConnection.BLOCK || pipe.south == TileEntityPipe.EnumPipeConnection.LEVER){
            ...
            if (pipe.west == TileEntityPipe.EnumPipeConnection.BLOCK || pipe.west == TileEntityPipe.EnumPipeConnection.LEVER){
            ...
            if (pipe.east == TileEntityPipe.EnumPipeConnection.BLOCK || pipe.east == TileEntityPipe.EnumPipeConnection.LEVER){
