...
public class TileEntityEmitterRenderer extends TileEntitySpecialRenderer<TileEntityEmitter> {
	...
	public TileEntityEmitterRenderer(){
		super();
	}
	
	@Override
	public void render(TileEntityEmitter tile, double x, double y, double z, float partialTicks, int destroyStage, float tileAlpha){
		if (tile != null){
            ...
            if (tile.south == TileEntityEmitter.EnumConnection.LEVER){
