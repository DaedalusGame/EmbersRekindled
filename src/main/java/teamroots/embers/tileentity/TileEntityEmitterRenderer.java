...
public class TileEntityEmitterRenderer extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialTicks, int destroyStage){
		if (tile instanceof TileEntityEmitter){
			TileEntityEmitter pipe = (TileEntityEmitter)tile;
            ...
            if (pipe.south == TileEntityEmitter.EnumConnection.LEVER){
