...
public class TileEntityFluidPipeRenderer extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityFast(TileEntity tile, double x, double y, double z, float partialTicks, int destroyStage, VertexBuffer buffer){
		if (tile instanceof TileEntityFluidPipe){
            ...
            if (pipe.up == TileEntityFluidPipe.EnumPipeConnection.PIPE || pipe.up == TileEntityFluidPipe.EnumPipeConnection.BLOCK){
            ...
            if (pipe.down == TileEntityFluidPipe.EnumPipeConnection.PIPE || pipe.down == TileEntityFluidPipe.EnumPipeConnection.BLOCK){
            ...
            if (pipe.north == TileEntityFluidPipe.EnumPipeConnection.PIPE || pipe.north == TileEntityFluidPipe.EnumPipeConnection.BLOCK){
            ...
            if (pipe.south == TileEntityFluidPipe.EnumPipeConnection.PIPE || pipe.south == TileEntityFluidPipe.EnumPipeConnection.BLOCK){
            ...
            if (pipe.west == TileEntityFluidPipe.EnumPipeConnection.PIPE || pipe.west == TileEntityFluidPipe.EnumPipeConnection.BLOCK){
            ...
            if (pipe.east == TileEntityFluidPipe.EnumPipeConnection.PIPE || pipe.east == TileEntityFluidPipe.EnumPipeConnection.BLOCK){
            ...
            if (pipe.up == TileEntityFluidPipe.EnumPipeConnection.BLOCK){
            ...
            if (pipe.down == TileEntityFluidPipe.EnumPipeConnection.BLOCK){
            ...
            if (pipe.north == TileEntityFluidPipe.EnumPipeConnection.BLOCK){
            ...
            if (pipe.south == TileEntityFluidPipe.EnumPipeConnection.BLOCK){
            ...
            if (pipe.west == TileEntityFluidPipe.EnumPipeConnection.BLOCK){
            ...
            if (pipe.east == TileEntityFluidPipe.EnumPipeConnection.BLOCK){
