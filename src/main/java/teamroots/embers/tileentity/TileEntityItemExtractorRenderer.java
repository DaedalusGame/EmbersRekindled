...
public class TileEntityItemExtractorRenderer extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialTicks, int destroyStage){
		if (tile instanceof TileEntityItemExtractor){
			TileEntityItemExtractor pipe = (TileEntityItemExtractor)tile;
            ...
            if (pipe.up == TileEntityItemExtractor.EnumPipeConnection.PIPE || pipe.up == TileEntityItemExtractor.EnumPipeConnection.BLOCK || pipe.up == TileEntityItemExtractor.EnumPipeConnection.LEVER){
            	RenderUtil.addBox(buffer, up.x1+x, up.y1+y, up.z1+z, up.x2+x, up.y2+y, up.z2+z, up.textures, new int[]{1,1,1,1,1,1});
            }
            if (pipe.down == TileEntityItemExtractor.EnumPipeConnection.PIPE || pipe.down == TileEntityItemExtractor.EnumPipeConnection.BLOCK || pipe.down == TileEntityItemExtractor.EnumPipeConnection.LEVER){
            	RenderUtil.addBox(buffer, down.x1+x, down.y1+y, down.z1+z, down.x2+x, down.y2+y, down.z2+z, down.textures, new int[]{-1,-1,1,1,1,1});
            }
            if (pipe.north == TileEntityItemExtractor.EnumPipeConnection.PIPE || pipe.north == TileEntityItemExtractor.EnumPipeConnection.BLOCK || pipe.north == TileEntityItemExtractor.EnumPipeConnection.LEVER){
            ...
            if (pipe.south == TileEntityItemExtractor.EnumPipeConnection.PIPE || pipe.south == TileEntityItemExtractor.EnumPipeConnection.BLOCK || pipe.south == TileEntityItemExtractor.EnumPipeConnection.LEVER){
            ...
            if (pipe.west == TileEntityItemExtractor.EnumPipeConnection.PIPE || pipe.west == TileEntityItemExtractor.EnumPipeConnection.BLOCK || pipe.west == TileEntityItemExtractor.EnumPipeConnection.LEVER){
            	RenderUtil.addBox(buffer, west.x1+x, west.y1+y, west.z1+z, west.x2+x, west.y2+y, west.z2+z, west.textures, new int[]{1,1,1,1,1,1});
            }
            if (pipe.east == TileEntityItemExtractor.EnumPipeConnection.PIPE || pipe.east == TileEntityItemExtractor.EnumPipeConnection.BLOCK || pipe.east == TileEntityItemExtractor.EnumPipeConnection.LEVER){
