...
public class BlockEmberPulser extends BlockTEBase {
	...
	public BlockEmberPulser(Material material, String name, boolean addToTab) {
	...
	public void onBlockAdded(World world, BlockPos pos, IBlockState state){
		if (world.getTileEntity(pos) instanceof TileEntityPulser){
			((TileEntityPulser)world.getTileEntity(pos)).updateNeighbors(world);
		}
	}
