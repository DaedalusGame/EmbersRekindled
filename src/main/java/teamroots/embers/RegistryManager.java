...
public class RegistryManager {
	...
	public static void registerAll(){
		...
		blocks.add(mechEdge = (new BlockMechEdge(Material.ROCK,"mechEdge",false)).setIsFullCube(false).setIsOpaqueCube(false).setHarvestProperties("pickaxe", 0).setHardness(1.0f));
		...
		blocks.add(stoneEdge = (new BlockStoneEdge(Material.ROCK,"stoneEdge",true)).setIsFullCube(false).setIsOpaqueCube(false).setHarvestProperties("pickaxe", 0).setHardness(1.0f));
